...
/*let maxspeed = Math.max (...players.map(p => p.speed));
...
for (let player of players) {
  console.log(`Character: ${player.name}, HP: ${player.hp}, Attack: ${player.attack}, Defense: ${player.defense}, Speed: ${player.speed}`);
}*/

/*for (let player of players) {
  if (player instanceof Neo) {
    player.Fly();     
  } else if (player instanceof Trinity) {
    player.Gun();
  } else if (player instanceof Morpheus) {
    player.Katana();
  } 
}*/
...
/*let player1 = new GenericCharacter("Hero", 100, Math.round(Math.random() * 100), Math.round(Math.random() * 100), 50);

let player2 = new Neo("Neo", 120, 90, 80, 70);

let Trinit = new Trinity("Trinity", 110, 85, 75, 65);

let Morpheu = new Morpheus("Morpheus", 130, 95, 85, 55);*/

//let enemy1 = new GenericCharacter("Goblin", 80, 15, 5, 10);

// Pruebas de los métodos específicos de cada clase

/*console.log("Player 2:", player2);
player2.Neo();
console.log("Player 2 whit Neo:", player2);
player2.Glasses();
console.log("Player 2 with Glasses:", player2);*/

/*console.log("trinity:", Trinit);
Trinit.Christ();
console.log("trinity with Christ:", Trinit);
Trinit.Gun();
console.log("trinity with Gun:", Trinit);*/
